...
public:
	...
	void afficherReglesJeu(){
		...
		Wt::WText* ExplanationsRules = root()->addWidget(std::make_unique<Wt::WText>("Trouvez le chemin le plus rapide pour emmener le robot objectif � la case object, en vous aidant des murs et de tous les autres robots\n Pour cela, cliquez sur l'un des robots, et indiquez l� o� vous souhaitez qu'il se dirige.\n"));
		Wt::WFont fontRules;
